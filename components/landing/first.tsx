...
export default function First() {
  return (
    <section className="bg-white relative grid grid-cols-12 py-10 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] ">
      ...
      <div className="py-8 duration-[600ms] col-span-7 fade-in-100 px-6 sm:px-4 sm:mx-12 max-w-screen-xl text-center md:text-left lg:py-16 z-10 relative">
        ...
        <div className="min-[250px] z-[50] max-w-[600px] w-full">
          ...
          <p className="mb-8 md:mb-1 text-left text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-200">
            ...
            encouragement, resilience, and hope. Together, we will navigate the
            path ahead.
          </p>
          <br />
          <Button
            asChild={true}
            className="w-fit translate-y-[1px] text-black transition-colors origin-bottom-left ease-in duration-200 hover:text-white border-2 border-primary-darker py-3 px-6 shadow-gray-400 max-sm:py-4 max-sm:px-12 flex gap-4 bg-transparent hover:bg-primary-darker"
          >
      ...
      <div className="hidden border col-span-5 lg:flex justify-start items-center z-[10]">
        <Image
          width={500}
          height={300}
          src="/Groupchatbot.svg"
