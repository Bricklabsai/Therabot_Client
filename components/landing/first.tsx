...
export default function First() {
  ...
  return (
    <section className="relative items-center">
      <div>
        <div className="container px-6 h-full lg:px-20 flex flex-col-reverse lg:flex-row  mx-auto pb-10 pt-6 sm:pt-2 w-full">
          <div className="py-2 duration-[600ms]  h-full w-full lg:w-1/2 fade-in-100 text-center md:text-left lg:py-8 z-10 relative">
            ...
            <a
              ...
              className="animate-hero-text-reveal inline-flex justify-between items-center py-1 px-1 pe-4 text-sm text-violet-700 bg-violet-100 rounded-full dark:bg-violet-900 dark:text-violet-300 hover:bg-violet-200 dark:hover:bg-violet-800"
            >
            ...
            <div className="min-[250px] pt-6 z-[50] max-w-[600px] w-full">
              <h1
          ...
          <div className="w-full lg:w-1/2 p-8 h-full flex justify-center lg:justify-start items-center z-[10]">
            <motion.img
              width={500}
              height={300}
