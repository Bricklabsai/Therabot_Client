                  ...
                  <div className="grid grid-cols-12 items-center w-full">
                    ...
                    <div className="grid grid-cols-10 col-span-3 sm:col-span-2">
                      <div className="col-span-3 -mr-[13px]">
                        <div
                          className={clsx(
                            `border-b border-l-0  h-1/2 w-full relative`,
                            working.border
                          )}
                        >
                        ...
                        <div
                          className={clsx(
                            `border-t  h-1/2 w-full relative`,
                            working.border
                          )}
                        >
                      ...
                      <div className="col-span-7 z-10 py-2">
                        <div
                          className={clsx(
                            `flex items-center justify-center rounded-full w-[40px] h-[40px] sm:w-[64px] sm:h-[64px] bg-gradient-to-r text-white font-bold z-10`,
                            working.from,
                            working.to
                          )}
                        >
