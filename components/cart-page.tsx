                  ...
                  <div className="flex flex-row justify-between">
                    <div className="flex w-fit items-center gap-4 rounded-md">
                      <button
                        ...
                        className="font-bold text-xl bg-primary-dark text-white p-2 rounded-md hover:bg-primary-darker"
                      >
                    ...
                    <div className="flex flex-row gap-4">
                      <button className="text-sm outline-none flex gap-2 items-center py-1 px-2 text-primary-dark hover:bg-primary-dark hover:text-white transition-colors ease-in duration-150 rounded-md border border-gray-200">
        ...
        <div className="col-span-4 gap-3 rounded-lg">
          ...
          <div className="rounded-lg bg-white p-4 border border-neutral-300">
            ...
            <div className="py-2 flex">
              <Link
                href={"/checkout"}
                className="text-center w-full flex-1 font-bold border py-2 px-4 rounded-md bg-primary-dark hover:bg-primary-darker text-white text-lg"
              >
                Checkout
              </Link>
            </div>
