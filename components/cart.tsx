    ...
    <>
      <Link href={'/cart'} className="flex flex-row gap-2 items-center">
        <div className="relative">
          <FiShoppingCart className="h-5 w-5 text-primary-dark" />
          {cartCount > 0 ? (
            <>
              <div className="text-[12px] w-[18px] h-[18px] flex flex-col justify-between items-center absolute -right-2 -top-2 rounded-full bg-primary-dark text-white">
